...
export default function CreateVideo() {
  ...
  // Add function to navigate back to dashboard
          ...
          <div className="bg-white p-4 md:p-6 rounded-lg shadow-sm border border-gray-100 space-y-4 md:space-y-6">
            ...
            <div className="flex flex-col md:flex-row gap-4">
              <Button
                type="button"
                variant="outline"
                className="md:w-1/3 h-10 md:h-14 text-sm md:text-lg font-medium"
              ...
              <Button
                type="submit"
                className="w-full md:w-2/3 bg-blue-700 hover:bg-blue-800 h-10 md:h-14 text-sm md:text-lg font-medium"
